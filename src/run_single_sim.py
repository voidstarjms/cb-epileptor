...
def main():
    ...
    params.G_INTRA = args.Gintra
    params.G_INTER = args.Ginter
    ...
    spike_matrix_1 = data_processing.create_spike_matrix_histo(res['spikes_n1'], params.NUM_CELLS)
    spike_matrix_2 = data_processing.create_spike_matrix_histo(res['spikes_n2'], params.NUM_CELLS)
