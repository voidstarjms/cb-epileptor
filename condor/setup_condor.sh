...
Arguments  = run_single_sim.py --ce \$(ce) --x0 \$(x0) --Gintra \$(Gintra) --Ginter \$(Ginter) --realization \$(realization)
...
Queue ce, x0, Gintra, Ginter, realization from $PROJ_DIR/src/params_list.txt
EOF
